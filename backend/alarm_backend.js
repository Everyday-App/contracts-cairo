...
class AlarmContractBackend {
    ...
    /**
     * Processes alarm data from an input file, calculates outcomes,
     ...
     */
    async processAlarmData(inputFile, outputFile) {
        try {
...
async function main() {
    ...
    const inputFile = './alarm_inputs.json';
    const outputFile = './alarm_outputs.json';

    try {
        const results = await backend.processAlarmData(inputFile, outputFile);
